        ...
        <div className="max-w-4xl mx-auto px-6 py-8">
            <div className="flex items-center justify-between mb-6">
                ...
                {user?.role === 'admin' && (
                    <Button
                        variant="outline"
                        onClick={() => navigate(createPageUrl(`admin/books/${id}/edit`))}
                    >
            ...
            <Card className="space-y-6">
                {book.cover_url ? (
                    ...
                    <div className="flex justify-center">
                        <div className="w-48 h-64 bg-gray-100 rounded-lg flex items-center justify-center">
                            <p className="text-gray-400 text-sm">表紙未設定</p>
                        </div>
                    </div>
                )}

                <div className="space-y-3">
                    <h1 className="text-3xl font-bold text-gray-900">{book.title || '未設定'}</h1>
                    {book.authors && book.authors.length > 0 ? (
                        <p className="text-lg text-gray-600">
                            {book.authors.join(', ')}
                        </p>
                    ) : (
                        <p className="text-lg text-gray-400">著者未設定</p>
                    )}
                </div>
                ...
                <div className="flex flex-wrap gap-3 pt-4 border-t">
                    ...
                    {book.amazon_url ? (
                        ...
                        <div className="flex-1 min-w-[200px] px-4 py-2 text-center text-gray-400 border border-gray-200 rounded-md">
                            購入リンク未設定
                        </div>
                    )}
                </div>
